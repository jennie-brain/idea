...
**정의**: SAM(428만 명, stock) 중 **초기 유통채널로 실제 확보할 Beachhead** — "결혼·신혼집·입주를 앞두고 가전·가구를 다건·고액 구매하고 카드 혜택을 적극 비교하는 사람." 여기서 처음으로 **연간(flow)** 시간축이 들어간다.
...
graph TD
    ...
    SAM --> Q1["Segment Q1: 혼인<br/>역할: 감지 쉬움(웨딩업체 신호)·강도 최고(1인당 722.5만원)<br/>👉 1차 표적"]:::target
    SAM --> Q2["Segment Q2: 입주(주택이유)<br/>역할: 감지 어려움(부동산 중개 파편화)·강도 미확인<br/>2차(리서치 최우선)"]:::other
    SAM --> Q3["Segment Q3: 해외여행<br/>역할: 감지 어려움(OTA 제휴 필요)·강도 낮음(1건당 약 102만원)<br/>대상 아님(현재)"]:::other
...
| 혼인 1인당 혼수지출 | 722.5만원 | [`01-혼인_결혼비용.md`](<./리서치-원본/04-TAM-SAM-SOM/01-혼인_결혼비용.md>) 1,445만÷2 | (추정) |
